...
<div id="modal-options1" data-izimodal-group="group1" data-izimodal-loop="" data-izimodal-title="ＬＩＮＥビーコンを活用したＩｏＴサービス">
	<div class="modal-base">
		<img src="../images/iot_img01.png" width="100%" height="auto" alt="lineビーコン" class="iot02_img mt-40"/>
		...
		<img src="../images/iot_modal_img00.png" width="100%" height="auto" alt="システム連携イメージ" class="modalImg80"/>
        <h3 align="center" class="modalh3 cblue">活用イメージ</h3>
      	<div class="imgs clearfix">
        	<div>
            	<img src="../images/iot_modal_img01.jpg" width="100%" height="auto" alt="商品詳細情報を配布"/>
            	<h4>商品詳細情報を配布</h4>
            </div>
        	<div>
            	<img src="../images/iot_modal_img02.jpg" width="100%" height="auto" alt="絵に近づくと詳細情報を配布"/>
            	<h4>絵に近づくと詳細情報を配布</h4>
            </div>
        	<div>
            	<img src="../images/iot_modal_img03.jpg" width="100%" height="auto" alt="店舗にてポイントを発行"/>
            	<h4>店舗にてポイントを発行</h4>
            </div>
        	<div>
            	<img src="../images/iot_modal_img04.jpg" width="100%" height="auto" alt="店頭にて限定クーポンを配布"/>
            	<h4>店頭にて限定クーポンを配布</h4>
            </div>
        	<div>
            	<img src="../images/iot_modal_img05.jpg" width="100%" height="auto" alt="ユーザーの位置情報を記録"/>
            	<h4>ユーザーの位置情報を記録</h4>
            </div>
        </div>
        <a href="https://reg31.smp.ne.jp/regist/is?SMPFORM=qck-silcp-d23ee8f7d2f6fb629a9cd2f0ca70d828" target="_blank" onclick="ga('send', 'event', 'iot', 'click', 'quest', 1, {'nonInteraction': 1});" class="links"><span>お問い合せフォーム</span><img src="../images/arrow_white.png" width="16" height="7" alt="arrow"/></a>
      
  </div
></div>
<div id="modal-options2" data-izimodal-group="group1" data-izimodal-loop="" data-izimodal-title="商業施設・イベント向けＩｏＴサービス ">
	<div class="modal-base">
    	<img src="../images/iot_modal_photo01.jpg" width="100%" height="auto" alt="商業施設・イベント向け" class="mb20"/>
    	...
    	<h3 align="center" class="modalh3 cblue">機能例</h3>
      	<div class="imgs clearfix">
        	<div>
            	<img src="../images/iot_modal_img06.jpg" width="100%" height="auto" alt="クーポン・ポイントの発行"/>
            	<h4>クーポン・ポイントの発行</h4>
            </div>
        	<div>
            	<img src="../images/iot_modal_img07.jpg" width="100%" height="auto" alt="顧客の導線分析"/>
            	<h4>クーポン・ポイントの発行</h4>
            </div>
        	<div>
            	<img src="../images/iot_modal_img08.jpg" width="100%" height="auto" alt="道案内・混雑状況の可視化"/>
            	<h4>道案内・混雑状況の可視化</h4>
            </div>
        	<div>
            	<img src="../images/iot_modal_img09.jpg" width="100%" height="auto" alt="音声ガイド・観光ガイド"/>
            	<h4>音声ガイド・観光ガイド</h4>
            </div>
        	<div>
            	<img src="../images/iot_modal_img10.jpg" width="100%" height="auto" alt="ゲーム・アトラクション"/>
            	<h4>ゲーム・アトラクション</h4>
            </div>
        	<div>
            	<img src="../images/iot_modal_img11.jpg" width="100%" height="auto" alt="広告・デジタルサイネージ"/>
            	<h4>広告・デジタルサイネージ</h4>
            </div>
        </div>
        <a href="https://reg31.smp.ne.jp/regist/is?SMPFORM=qck-silcp-d23ee8f7d2f6fb629a9cd2f0ca70d828" target="_blank" onclick="ga('send', 'event', 'iot', 'click', 'quest', 1, {'nonInteraction': 1});" class="links"><span>お問い合せフォーム</span><img src="../images/arrow_white.png" width="16" height="7" alt="arrow"/></a>
...
<div id="modal-options3" data-izimodal-group="group1" data-izimodal-loop="" data-izimodal-title="アジャイル開発×ＩｏＴサービス">
	<div class="modal-base">
    	<img src="../images/iot_modal_photo02.png" width="100%" height="auto" alt="アジャイル開発×ＩＯＴサービス" class="mb20"/>
        <ul>
        ...
        <div class="clearfix agile">
        	<img src="../images/iot_modal_img12.png" width="100%" height="auto" alt="IoTプロト開発"/>
